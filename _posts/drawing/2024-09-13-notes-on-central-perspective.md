...
结合以上3种**定位物体在画面中的位置**方法可以看出，只要找出以下三条线中的任意两条，都可以定位物体在画面中的位置：
...
下表展示了三种对象在一副从 1.6 米（63 英寸）的距离观看的图像上所对应的画面尺寸：一栋现代单层住宅（从地面到屋顶高度 20 英尺，约6米），代表建筑或景观；一个平均身高的男子（5 英尺 9 英寸，约1.75米），代表人物；以及一个篮球（直径 9.5 英寸，约24厘米），代表静物。
